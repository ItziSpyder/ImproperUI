...
public class ImproperUIRoundRectTexState implements GuiElementRenderState {
    ...
    public ImproperUIRoundRectTexState(RenderPipeline pipeline, TextureSetup texture, Matrix3x2f pose, float x, float y, float w, float h, float r, ScreenRectangle scissor, ScreenRectangle bounds) {
    ...
    public ImproperUIRoundRectTexState(Matrix3x2f pose, Identifier texture, float x, float y, float w, float h, float r, ScreenRectangle scissor) {
    ...
    public ImproperUIRoundRectTexState(GuiGraphicsExtractor context, Identifier texture, float x, float y, float w, float h, float r) {
