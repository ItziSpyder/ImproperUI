...
public class ImproperUIRoundRectWireframeState implements GuiElementRenderState {
    ...
    public ImproperUIRoundRectWireframeState(Matrix3x2f pose, float x, float y, float w, float h, float r, float thickness, int colorInner1, int colorOuter1, int colorInner2, int colorOuter2, int colorInner3, int colorOuter3, int colorInner4, int colorOuter4, ScreenRectangle scissor) {
    ...
    public ImproperUIRoundRectWireframeState(GuiGraphicsExtractor context, float x, float y, float w, float h, float r, float thickness, int colorInner1, int colorOuter1, int colorInner2, int colorOuter2, int colorInner3, int colorOuter3, int colorInner4, int colorOuter4) {
    ...
    public ImproperUIRoundRectWireframeState(GuiGraphicsExtractor context, float x, float y, float w, float h, float r, float thickness, int colorInner, int colorOuter) {
    ...
    public ImproperUIRoundRectWireframeState(GuiGraphicsExtractor context, float x, float y, float w, float h, float r, float thickness, int color) {
