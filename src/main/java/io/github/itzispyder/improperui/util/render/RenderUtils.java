...
public final class RenderUtils {
    ...
    // special
    public static void drawBox(GuiGraphicsExtractor context, int x, int y, int w, int h, int color) {
    ...
    public static void drawLine(GuiGraphicsExtractor context, int x1, int y1, int x2, int y2, int color) {
        drawLine(context, x1, y1, x2, y2, 0.5F, color);
    }

    public static void drawLine(GuiGraphicsExtractor context, int x1, int y1, int x2, int y2, float thickness, int color) {
        float dx = x2 - x1;
        float dy = y2 - y1;
        ...
        context.pose().rotateAbout(angle, x1, y1);
        context.guiRenderState.addGuiElement(new ImproperUIQuadState(context,
                x1 - t, y1 - t,
                x1 + length + t, y1 - t,
                x1 + length + t, y1 + t,
                x1 - t, y1 + t,
    ...
    public static void drawDefaultCode(GuiGraphicsExtractor context, String code, int x, int y, boolean shadow, int color) {
        context.text(system.codeRenderer, code, x, y, color, shadow);
    }

    // fill

    public static void fillRect(GuiGraphicsExtractor context, int x, int y, int w, int h, int color) {
        context.guiRenderState.addGuiElement(new ImproperUIQuadState(context, x, y, w, h, color));
    }
    ...
    public static void fillVerticalGradient(GuiGraphicsExtractor context, int x, int y, int w, int h, int colorTop, int colorBottom) {
        context.guiRenderState.addGuiElement(new ImproperUIQuadState(context, x, y, w, h, colorTop, colorTop, colorBottom, colorBottom));
    }
    ...
    public static void fillRoundRect(GuiGraphicsExtractor context, int x, int y, int w, int h, int r, int color) {
        context.guiRenderState.addGuiElement(new ImproperUIRoundRectState(context, x, y, w, h, r, color));
    }
    ...
    public static void fillRoundRectGradient(GuiGraphicsExtractor context, int x, int y, int w, int h, int r, int color1, int color2, int color3, int color4, int colorCenter) {
        context.guiRenderState.addGuiElement(new ImproperUIRoundRectState(context, x, y, w, h, r, color1, color2, color3, color4, colorCenter));
    }
    ...
    public static void fillRoundShadowGradient(GuiGraphicsExtractor context, int x, int y, int w, int h, int r, float thickness, int inner1, int outer1, int inner2, int outer2, int inner3, int outer3, int inner4, int outer4) {
        context.guiRenderState.addGuiElement(new ImproperUIRoundRectWireframeState(context, x, y, w, h, r, thickness, inner1, outer1, inner2, outer2, inner3, outer3, inner4, outer4));
    }
    ...
    public static void drawRoundTexture(GuiGraphicsExtractor context, Identifier texture, int x, int y, int w, int h, int r) {
        context.guiRenderState.addGuiElement(new ImproperUIRoundRectTexState(context, texture, x, y, w, h, r));
    }
