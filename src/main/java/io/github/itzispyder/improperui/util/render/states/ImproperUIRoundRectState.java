...
public class ImproperUIRoundRectState implements GuiElementRenderState {
    ...
    public ImproperUIRoundRectState(RenderPipeline pipeline, TextureSetup texture, Matrix3x2f pose, float x, float y, float w, float h, float r, int color1, int color2, int color3, int color4, int colorCenter, ScreenRectangle scissor, ScreenRectangle bounds) {
    ...
    public ImproperUIRoundRectState(Matrix3x2f pose, float x, float y, float w, float h, float r, int color1, int color2, int color3, int color4, int colorCenter, ScreenRectangle scissor) {
    ...
    public ImproperUIRoundRectState(GuiGraphicsExtractor context, float x, float y, float w, float h, float r, int color1, int color2, int color3, int color4, int colorCenter) {
        this(new Matrix3x2f(context.pose()), x, y, w, h, r, color1, color2, color3, color4, colorCenter, context.scissorStack.peek());
    }

    public ImproperUIRoundRectState(GuiGraphicsExtractor context, float x, float y, float w, float h, float r, int color) {
